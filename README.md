...
사용자 경험과 유지보수성을 고민하며 웹 서비스를 만드는 프론트엔드 개발자입니다.<br>
React와 Next.js 생태계를 중심으로 배우고 실험한 내용을 코드로 기록합니다.
...
I'm a frontend developer building maintainable web experiences with users in mind.<br>
I learn, experiment, and document my work through code, mainly in the React and Next.js ecosystem.
